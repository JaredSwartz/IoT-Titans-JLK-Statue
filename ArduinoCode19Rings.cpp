...
void setRingDebug()
{
    for (int j = 0; j < 16; j++)
    {
        muxArrayB[fullRow][j].setColor(white);
    }
}

void setCrystalUnsorted(int row, int column, Color color)
{
    ...
    for (int i = 0; i < 13; i++)
    {
        for (int j = 0; j < 22; j++)
        {
            ...
            {
            case 0:
                sortedArray[i][j]->setColor(red);
                break;
            case 1:
                sortedArray[i][j]->setColor(orange);
                break;
            case 2:
                sortedArray[i][j]->setColor(yellow);
                break;
            case 3:
                sortedArray[i][j]->setColor(green);
                break;
            case 4:
                sortedArray[i][j]->setColor(blue);
                break;
            case 5:
                sortedArray[i][j]->setColor(indigo);
                break;
            case 6:
                sortedArray[i][j]->setColor(white);
                break;
            default:
                break;
            }
